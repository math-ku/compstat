...
which follows from differentiation under the integral of $\int h(y \mid x, \theta) \mathrm{d}y = 1.$
...
```{r mixture-convergence, echo = FALSE, fig.width = 10, fig.height = 8, fig.show = "animate"}
...
for (i in seq_len(nrow(EM_trace))) {
