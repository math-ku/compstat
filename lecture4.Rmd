...
Thus
$$\operatorname{MSE}(x) = \underbrace{\left[f(x) - \frac{1}{k} \sum_{l \in N(x)} f(x_l)\right]^2}_{\text{squared bias}} \underbrace{\frac{\sigma^2}{k}}_{\text{variance}}.$$
...
```{r nuuk-spline-opt, fig.width = 9, fig.height = 5.5}
