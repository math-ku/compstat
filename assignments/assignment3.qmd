...
investigate how the algorithms converge as a function of *real* time (not
iterations).
...
Then implement the EM algorithm for estimating $(\mu, \sigma^2)$, compare it to
other optimization algorithms based on the marginal log-likelihood, and
...
$t$-distributions. Compare the algorithm with e.g. gradient descent or another
...
As an optional extension, implement a computation of the Fisher information.
