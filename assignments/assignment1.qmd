...
consider simulated data as well---in particular with respect benchmarking and
profiling. Note that the teaching material covers some matrix decomposition
techniques that can be particularly relevant in combination with LOOCV.
