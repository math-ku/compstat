...
to read the documentation carefully, in particular the documentation of the
`bw` argument. 
...
consider simulated data as well---in particular with respect benchmarking and profiling.
