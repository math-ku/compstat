...
$n$. We are interested in computing the _ruin probabilities_ before time $n$:
...
$$
g*{\theta, n}(x) = \frac{1}{\varphi(\theta)^n} \exp\left(\theta \sum*{k=1}^n
x_k\right)
$$
...
$$
\varphi(\theta) = \int\_{-1.9}^2 e^{\theta z} \mathrm{d}z.
$$
