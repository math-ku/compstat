...
to make correct comparisons. Benchmarks are interesting for e.g. gradient
...
$$
\frac{1}{N} \sum_{i=1}^N \big(y_i - f(x_i \mid \alpha, \beta, \gamma, \rho)\big)^2.
$$
...
or generate $\log(x)$ from a $\mathcal{N}(0, \omega^2)$-distribution. Consider
how you could exploit if the $x$-s all fall in a small number of grid points in
your implementation.
