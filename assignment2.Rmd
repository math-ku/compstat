---
title: 'Assignment 2: Univariate Simulation'
...
This assignment uses the Poisson data available from Absalon. It is a table 
with 100 rows and two variables, $z$ and $x$, where $z$ takes integer values and $x$ 
