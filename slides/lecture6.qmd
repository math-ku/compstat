...
More commonly, just run until the empirical confidence interval is sufficiently narrow.
...
```{r}
#| echo: false
#| fig-cap: "Target and importance densities
...
#| echo: false
#| fig-height: 3
#| fig-cap: "Densities, integrand, and weights for the importance sampling example
...
#| fig-height: 3
#| fig-cap: "Densities, integrand, and weights for the importance sampling example
#|   with Student-$t$ as importance distribution."
dens_df_t <- tibble(
  x = x_grid,
  target = dnorm(x_grid, 0, 1),
...
#| fig-height: 3
#| fig-cap: "Convergence of the importance sampling estimate of the mean of a
#|   Gamma(8,1) distribution using normalized weights."
...
#| fig-width: 4.5
#| fig-cap: "Importance sampling estimate of the mean of a Gamma(8,1)
#|   distribution with 95% confidence bands using normalized weights."
p +
  geom_ribbon(
    aes(
...
Start with an initial importance distribution and refine it based on samples
and weights.
...
Implement an importance sampler for computing the mean of the von
Mises distribution. Plot the result and check convergence towards $\mu$.
...
weights. Experiment with different importance densities to see if you find
a better one.
