...
#| label: gamma-IS-fig1
#| echo: false
#| fig-cap: "Convergence of the importance sampling estimate of the mean of a Gamma(8,1) distribution using a N(10,3) importance distribution."
#| fig-width: 5
#| fig-height: 2.5
...
#| echo: false
#| fig-height: 3
#| fig-cap: "Densities, integrand, and weights for the importance sampling example with a normal importance distribution."
set.seed(1)
n <- 1000
x_norm <- rnorm(n)
...
#| echo: false
#| fig-height: 3
#| fig-cap: "Densities, integrand, and weights for the importance sampling example with Student-$t$ as importance distribution."
dens_df_t <- tibble(
  x = x_grid,
  target = dnorm(x_grid, 0, 1),
...
#| fig-width: 4.5
#| fig-height: 3
#| fig-cap: "Convergence of the importance sampling estimate of the mean of a Gamma(8,1) distribution using normalized weights."
...
#| echo: false
#| fig-width: 4.5
#| fig-cap: "Importance sampling estimate of the mean of a Gamma(8,1) distribution with 95% confidence bands using normalized weights."
p +
  geom_ribbon(
    aes(
...
#| echo: false
#| fig-height: 2.3
#| fig-cap: "Target (blue) and importance (orange) densities with samples from the importance distribution."
library(mvtnorm)
...
```{r}
#| echo: false
#| fig-cap: "Target (solid black) and Laplace approximation (dashed blue) densities for a Gamma(3,1) distribution."
...
#| echo: false
#| fig-cap: "Target (black) and importance (blue) densities with samples from the importance distribution."
...
#| fig-height: 3
#| fig-width: 2.7
#| fig-cap: "Target (black) and importance (orange) densities with samples from the defensive importance mixture distribution."
#| echo: false
set.seed(1234)
B <- 1000
