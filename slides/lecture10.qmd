...
$$
  \Phi(\theta') = \operatorname{argmax}_{\theta \in \Theta} Q(\theta \mid \theta').
$$
...
$$
  \lVert\theta_{n + 1}
  - \hat{\theta}\rVert \approx \rho \lVert\theta_n
  - \hat{\theta}\rVert, \qquad 0
                                            < \rho
                                            < 1.
$$
...
$$
  \log \lVert\theta_{n + 1}
  - \hat{\theta}\rVert \approx \log \rho
  + \log \lVert \theta_n
  - \hat{\theta}\rVert
                                                 \implies \log \lVert \theta_n
                                                          - \hat{\theta}\rVert
                                                 \approx n \log \rho
                                                         + \text{constant}.
$$
