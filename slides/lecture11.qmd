...
plot(
  ...
  ylab = "f(x)",
  xlab = "x",
  main = "Strong Convexity Visualization"
)
lines(x, tangent, col = "red", lwd = 2, lty = 2)
lines(x, sc_bound, col = "green", lwd = 2, lty = 3)
points(x0, f(x0), pch = 19)
legend(
  "topright",
  legend = c("f(x)", "Tangent at x0", "Tangent + mu/2 (x-x0)^2"),
