...
Minimize 
$$
\frac{1}{n} \sum_{i=1}^n f_i(\beta), \qquad f_i(\beta) = \frac{1}{2} (y_i - x_i \beta)^2 + \frac{\lambda}{2} \beta^2
$$
...
Implement a stochastic gradient descent method for solving this problem. Plot
convergence in terms of epochs and time. Test your implementation against R's
built-in `optimize()` or an analytical solution. 
