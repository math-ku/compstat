...
Compute expected # of heads for each coin and divide by expected #
of flips.

\medskip\pause

### Example Table After One Iteration
...
- **E-step:** compute $\gamma_{i}^{(t)}$, the expected values
  (responsibilities) of the latent variables.
