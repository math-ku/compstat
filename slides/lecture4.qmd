...
![](../images/parallelization-cores.png){width=100%}
...
![](../images/hpc-cluster.png){width=88%}
...
For $k = 3$, the orange bracket marks the current neighborhood. The blue points
trace the running mean.
...
- Parallelization delegates work across your CPU cores to speed up computations.\pause
