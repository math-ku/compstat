...
::: {.columns}
::::: {.column width="47%"}
For gradient descent with $t = 1/L$, the optimal choice of $\mu_k$ for general
convex and smooth $f$ is
$$
...
2. **Gradient norm monitoring**: Track $\|\nabla f(x_k)\|_2$ during training and
...
1. Minimize $f(x_1, x_2) = (a - x_1)^2 + b(x_2 - x_1^2)^2$ with $a = 1$ and
   $b = 100$ using gradient descent. Optimum is $(a, a^2)$.\pause
