...
It is a simple but informal system: no formal object definition and no type checking.
...
One common use of OOP is to make it easier to handle objects that your
...
using the `testthat` package.\pause 
Here's a rough idea:
...
Sample a data set from a Gaussian mixture model, varying the
