...
Histograms are not smooth, but if we admit stronger assumptions, we can get a
smoother estimate of the distribution, using **kernel density estimation**
(KDE).
...
Kasper Niss, PhD student, will cover for Jin when he is away.
...
Generative AI (e.g. GPT, Claude, Gemini, etc.) have changed the way we work with
code and data.
