...
The course is evolving and (hopefully) improving. Some changes from last
year:\pause

- The notation in the slides and assignments is more consistent with the
  book.\pause
- Assignments are more even in difficulty.\pause
- Slide material has been trimmed down.

\medskip\pause

Most of the changes are based on feedback from evaluations of last year's
course.
...
A newer alternative, based on VS Code, that supports other programming languages
as well.
...
You can also use VS Code directly, but mostly useful if you work with multiple
programming languages or already have it set up.
