...
tools to visualize profiling
output.^[Can be activated directly in
RSTudio (but not Positron)].
...
#| fig-width: 4
#| echo: false
#| fig-cap: The standard density estimator as a black line and
#|   the binning estimate as a filled area.
set.seed(123)
