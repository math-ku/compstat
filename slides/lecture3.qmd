...
provides useful visualization tools. Can also be called activated through the
...
[bench](https://cran.r-project.org/web/package=bench) for
benchmarking.
...
R stores matrices are in \alert{column-major order}.
