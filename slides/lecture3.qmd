...
A good place to start is to benchmark your code against existing
implementations^[Provided they exist!].

\pause\medskip

### Example

For instance, let's say we want to compute the standard deviation
of each column of a matrix.


## Profiling

But if your code **is** too slow, then it's time to 
...
The term is somewhat misleading, since it does not necessarily involve vector
processors.
