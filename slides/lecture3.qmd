...
Before thinking about improving performance, consider if you even need to. Maybe
...
::: {.columns}
::::: {.column width="47%"}
### Two Types of Profiling {.example}
...
tools to visualize profiling output.^[Can be activated directly in RSTudio (but
not Positron)].
...
necessary for default plot behavior.
