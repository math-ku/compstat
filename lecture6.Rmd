...
- But need to know variance for Chebychev-based bound and
...
## Exercise: Rejection vs Importance Sampling

- Pretend it is hard to sample from the Exponential distribution.
- Implement rejection sampling and importance sampling for the Exponential distribution
  to estimate the mean of the distribution.
- Use your stopping rule from before to stop when the confidence interval is 0.1 units wide.
- Benchmark your methods against each other.
